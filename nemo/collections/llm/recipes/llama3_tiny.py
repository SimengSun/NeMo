...
from nemo.collections.llm.gpt.model.llama import Llama3ConfigTiny, LlamaModel
...
def model() -> run.Config[pl.LightningModule]:
    ...
    Examples:
        ...
        Python API usage:
            ...
            >>> print(model_config)
    """
    return run.Config(LlamaModel, config=run.Config(Llama3ConfigTiny))
...
def pretrain_recipe(
    ...
    return run.Partial(
        ...
        data=run.Config(MockDataModule, seq_length=1024, global_batch_size=16, micro_batch_size=1),
